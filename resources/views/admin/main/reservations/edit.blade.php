...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Редактирование блока - Бронь на главной</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form role="form" method="post" action="{{ route('admin.reservations.update', ['reservation' => $reservation->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card card-primary card-outline card-tabs">
                            <div class="card-header">
                                <h3 class="card-title">Бронь стола на главной</h3>
                            </div>
                                    ...
                                    <div class="tab-pane fade active show" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_ru"
                                                   ...
                                                   value="{{ $reservation->title_ru }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="description_ru">Описание на главной (русский)</label>
                                            <textarea name="description_ru" class="form-control @error('description_ru') is-invalid @enderror" rows="5" id="description_ru">{{ $reservation->description_ru }}</textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_en"
                                                   ...
                                                   value="{{ $reservation->title_en }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="description_en">Описание на главной (английский)</label>
                                            <textarea name="description_en" class="form-control @error('description_en') is-invalid @enderror" rows="5" id="description_en">{{ $reservation->description_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
